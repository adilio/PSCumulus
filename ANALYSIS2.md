...
>
> The module is read-oriented. Most inventory queries do not have corresponding write commands, and the ones that do — `Start-CloudInstance`, `Stop-CloudInstance` — are on the roadmap to gain `-WhatIf` support. They should already have it. That one's on me.
>
