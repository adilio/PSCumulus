...
**Current status:** v0.7.0 delivers Stage 4 navigation (`Get-CloudResource`, path-driven `Set-CloudTag`) and revives the snapshot/image inventory surface held back from v0.6.0.
