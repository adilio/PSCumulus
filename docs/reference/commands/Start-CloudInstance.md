...
```
Start-CloudInstance -Name <string> -ResourceGroup <string> [-Provider <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Start-CloudInstance -Name <string> -Project <string> -Zone <string> [-Provider <string>] [-WhatIf]
...
```
Start-CloudInstance -InstanceId <string> [-Provider <string>] [-Region <string>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
Starts an Azure VM from piped PSCumulus instance output.
