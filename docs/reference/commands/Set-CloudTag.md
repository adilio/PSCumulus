...
```
Set-CloudTag -Name <string> -ResourceGroup <string> -Tags <hashtable> [-Merge] [-WhatIf]
...
```
Set-CloudTag -ResourceId <string> -Region <string> -Tags <hashtable> [-Merge] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```
Set-CloudTag -Project <string> -Resource <string> -Tags <hashtable> [-Merge] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```
Set-CloudTag -Path <string> -Tags <hashtable> [-Merge] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
