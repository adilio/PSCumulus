...
```
Get-CloudImage -ResourceGroup <string> [-Provider <string>] [-Name <string>] [-Tag <hashtable>]
...
```
Get-CloudImage -Project <string> [-Provider <string>] [-Name <string>] [-Tag <hashtable>]
 [-Detailed] [<CommonParameters>]
```
...
```
Get-CloudImage -Region <string> [-Provider <string>] [-Name <string>] [-Tag <hashtable>] [-Detailed]
 [<CommonParameters>]
```
...
```
Get-CloudImage -All [-Name <string>] [-Tag <hashtable>] [-Detailed] [<CommonParameters>]
```
...
caller's AWS AMIs, and the caller's GCP images.
